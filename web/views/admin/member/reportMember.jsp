												...
												<table width="100%"
													...
													<tbody>
														...
														<tr>
															...
															<td class="hide hideOk" id="cdTd" colspan="2" style="display:none"></td>
														...
														<tr>
															<td colspan="6"><textarea id="ctTa" class="col-lg-12" rows="3" readonly></textarea></td>
														</tr>
														<tr class="hide" style="display:none">
															<td colspan="6" class="MTR">- 부적합 사유</td>
														</tr>
														<tr class="hide" style="display:none">
															<td colspan="6"><textarea id="rejectTd" class="col-lg-12" rows="3" readonly></textarea></td>
														</tr>
													</tbody>
												</table>
											</div>
